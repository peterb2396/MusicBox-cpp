...
void WiFiManager::handleRoot() {
  ...
  HTTPSend(page);  if(_preloadwifiscan) WiFi_scanNetworks(_scancachetime,true); // preload wifiscan throttled, async
...
void WiFiManager::handleWifi(boolean scan) {
  ...
  // I added for making this the root
  ...
  // Add the parameters to the page
  ...
  // I added to make this the root
   if(_preloadwifiscan) WiFi_scanNetworks(_scancachetime,true); // preload wifiscan throttled, 
